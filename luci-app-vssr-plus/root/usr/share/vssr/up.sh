...
wget -4 -O /usr/share/koolproxy/kpupdate https://raw.githubusercontent.com/firkerword/KPR/main/kpupdate  && chmod 775 /usr/share/koolproxy/kpupdate

wget -4 -O /usr/bin/AdGuardHome/AdGuardHome https://raw.githubusercontent.com/firker/diy-ziyong/main/luci-app-adguardhome/root/usr/bin/AdGuardHome/AdGuardHome  && chmod 775 /usr/bin/AdGuardHome/AdGuardHome
